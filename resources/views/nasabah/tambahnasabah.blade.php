        ...
        <div class="card card-primary col-sm-6">
              ...
              <form action="{{route('nasabah.store')}}" method="post" enctype="multipart/form-data">
               ...
               <div class="col-12 col-sm-12">
                    ...
                    <input type="text" name="name" class="form-control " id="name" placeholder="Masukan username ...">
                </div>
                ...
                <div class="row">
                    ...
                    <input type="number" name="roles" class="form-control " id="roles" placeholder="Masukan roles ...">
                    </div>
                </div>

                <div class="col-12 col-sm-12">
                    <label for="alamat">Alamat</label>
                    <input type="varchar" name="alamat" class="form-control " id="alamat" placeholder="Masukan alamat ...">
                </div>
